    ...
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-edit-outline" @click="onSave"
            >保存流程</el-button
          >
          <el-button
...
import DefaultEmptyXML from "../utils/defaultXml";
// 翻译方法
...
export default {
  ...
  computed: {
    ...
    // 当前是否是小窗口
    // previewDialogWidth() {
    //   return this.getClientWidth < 600 ? "95%" : "60%";
    // },
  ...
  methods: {
    ...
    async createNewDiagram(xml) {
      ...
      try {
        ...
        warnings.forEach((el) => {
          el.element.beforeSubmit = el.property === "beforeSubmit" ? el.value : el.element.beforeSubmit;
          el.element.afterSubmit = el.property === "afterSubmit" ? el.value : el.element.afterSubmit;
        });
